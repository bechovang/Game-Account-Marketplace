...
/**
 * RemoveFavoriteModal - Confirmation modal for removing accounts from favorites
 * Shows warning message and requires confirmation before removal
 */
...
const RemoveFavoriteModal = ({ isOpen, isLoading, onConfirm, onCancel }: RemoveFavoriteModalProps) => {
  return (
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                          You can always add it back later by clicking the heart icon on the listing.
                        </p>
                      </div>
                    </div>
                  </div>
